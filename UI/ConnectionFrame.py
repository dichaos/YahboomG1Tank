...
class ConnectionFrame(tk.LabelFrame):
    def __init__(self, master, width, height, text):
        super(ConnectionFrame, self).__init__(master, width = width, height = height, text = text, bg="red")
        ...
        lb2 = Label(self, text = "Port:")
        lb2.grid(row = 1, column = 0, sticky = E, padx = 3, pady = 3)

        self.PortEntry = Entry(self, width = 15)
        self.PortEntry.grid(row = 1, column = 1, sticky = W, padx = 3, pady = 3)
